...
public class C01_WrapperClasses {
    ...
    public static void main(String[] args) {
        ...
        int number = 12; // "number" variable doesn't have any ready method to use because it is primitive method

        String str = "John Doe";

        System.out.println(str.length()); // Length() method returns integer value for the amount of characters you have

        Integer numberWrapper = 12; // "numberWrapper" variable has some ready method because it is Non-primitive data type
