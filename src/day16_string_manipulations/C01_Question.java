...
//Question 2: Get a String from the user and the text to be searched. Check the usage of the desired text in the String and print the appropriate one of the following sentences
...
public class C01_Question {
    public static void main(String[] args) {
        ...
        System.out.println("Please provide another a string");
