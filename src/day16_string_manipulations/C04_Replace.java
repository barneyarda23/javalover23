...
public class C04_Replace {
    public static void main(String[] args) {
        ...
        System.out.println(str.replace(" ", ""));//Javaisbetterthanany to get rid of the space.
        ...
        String str5 = "Jaca is easy";

        System.out.println(str5.replaceFirst("c", "v")); //Java is easy , it will replace the first occurrence.
