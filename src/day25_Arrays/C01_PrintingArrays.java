...
public class C01_PrintingArrays {
    public static void main(String[] args) {
       ...
       System.out.println(intArray);//[I@7c75222b I cannot directly print an array.

        System.out.println(Arrays.toString(intArray));//Arrays.toString() method helps to print an Array.
